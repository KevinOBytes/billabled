...
This directory explains the AI-agent guidance checked into SOWLedger.
...
- `.cursor/rules/sowledger.mdc`: delegates Cursor to `AGENTS.md`.
- `.codex/skills/*/SKILL.md`: repo-local Codex skill drafts for SOWLedger-specific work.
