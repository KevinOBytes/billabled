      ...
      {open && (
        <div className="absolute right-0 z-50 mt-2 w-52 rounded-2xl border border-stone-200 bg-white py-1 shadow-sm shadow-stone-900/10">
          ...
          <div className="border-b border-stone-200 px-4 py-3">
            ...
            {isAdmin && (
              <span className="mt-1 inline-flex items-center gap-1 rounded-full bg-cyan-50 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-cyan-700">
          ...
          <div className="py-1">
            {isAdmin && (
              <button
                ...
                className="flex w-full items-center gap-2.5 px-4 py-2 text-sm text-slate-600 hover:bg-cyan-50 hover:text-cyan-800"
              >
          ...
          <div className="border-t border-stone-200 py-1">
            <button
              ...
              className="flex w-full items-center gap-2.5 px-4 py-2 text-sm text-slate-600 hover:bg-rose-50 hover:text-rose-700"
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="h-4 w-4 text-slate-400">
