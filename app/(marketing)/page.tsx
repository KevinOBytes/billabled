      ...
      <section id="recovery" className="border-y border-border bg-surface px-4 py-20 sm:px-6 sm:py-24">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          ...
          <div>
            ...
            <p className="mt-5 text-lg leading-8 text-slate-600">
              Billabled turns analytics into review queues for work that should be protected, corrected, invoiced, or explained with evidence.
            </p>
            <div className="mt-8 divide-y divide-border border-y border-border">
              {[
                {
        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div>
            ...
            <p className="mt-5 text-lg leading-8 text-slate-300">
              Agency systems can fetch invoice proof, revenue intelligence, exports, and event updates through scoped keys while billing changes, invites, subscription management, and workspace administration stay inside Billabled.
            </p>
