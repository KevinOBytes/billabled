...
export default function LoginPage() {
  return (
    <div className="app-shell-bg flex min-h-screen flex-col items-center justify-center px-4 py-10">
      <Suspense fallback={<div className="grid w-full max-w-5xl gap-6 lg:grid-cols-[0.95fr_1.05fr] lg:items-center"><div className="h-96 w-full animate-pulse rounded-2xl bg-stone-100" /></div>}>
        <LoginForm />
      </Suspense>
    </div>
  );
